...
```{r,echo=F}
raw_global_dens_estimate <- ggplot(aes(x=Distance),data=school_data@bef_data$FFR) +
...
unless we explicitly correct for them. This might be a good reason to try the beta mixing measure instead, though it should be noted that since
