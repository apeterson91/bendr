...
fit <- nd_nhpp(X=matrix(1,ncol=1,nrow=nrow(n_j)),
               ...
               a_alpha = 3, b_alpha = 3, ## alpha Gamma prior hyperparameters
               a_rho = 3, b_rho = 3, ## rho Gamma prior hyperparameters
               iter_max = 5E4,
               warm_up = 4E4,
               thin = 1,
               seed = 34143)
...
```{r}
plot_cluster_densities(fit,switch='color',transform = FALSE)
```
